...
browserify({standalone: "acorn"})
  ...
  .transform(babelify)
  .require("./src/scripts.js", {entry: true})
  .bundle()
...
function acornShim(file) {
  ...
  if (file == path.resolve(__dirname, "../src/scripts.js")) {
    var sent = false
...
browserify({standalone: "acorn.loose"})
  ...
  .transform(acornShim)
  .transform(babelify)
  .require("./src/loose/scripts.js", {entry: true})
  .bundle()
  .on("error", function (err) { console.log("Error: " + err.message) })
...
browserify({standalone: "acorn.walk"})
  ...
  .transform(acornShim)
  .transform(babelify)
  .require("./src/walk/scripts.js", {entry: true})
  .bundle()
  .on("error", function (err) { console.log("Error: " + err.message) })
